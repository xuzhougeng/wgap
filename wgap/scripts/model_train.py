...
def prepare_augustus_training_data(gff3_file, genome_fasta, species_name, intergenic_size=1000, config_path="augustus/config"):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--gene_number", type=int, help="number of genes to use for training", default=500)
    ...
    if args.model == "snap":
        ...
        test_gb = prepare_augustus_training_data(args.gff3, args.genome, args.prefix, args.intergenic_size)
